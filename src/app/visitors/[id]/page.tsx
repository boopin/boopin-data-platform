...
export default function VisitorProfilePage() {
  ...
  // Check if tab=journey is in the URL, otherwise default to 'timeline'
  const defaultTab = searchParams.get('tab') === 'journey' ? 'timeline' : 'timeline';
  const [activeTab, setActiveTab] = useState<'timeline' | 'identity'>(defaultTab);
